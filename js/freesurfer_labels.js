var atlas_colors = {
		...
		"14": ["3 rd - Ventricle", 204, 182, 142, 0],
		"15": ["4 th - Ventricle", 42, 204, 164, 0],
    ...
    "72": ["5 th - Ventricle", 120, 190, 150, 0],
...
/*
		"for": ["keeping track of voxel changes],
    ...
    "	":	["# Cerebellar parcellation labels from SUIT(matches labels in cma.h)# No.Label Name: R G B A],
    ...
    "678": ["Cbm_Left_TONs 189 197 117 0],
		"679": ["Cbm_Left_FLOs 240 230 140 0# Added by DNG 7 / 31 / 14],
    ...
    "":	["# Below is the color table],
		"for": ["the cortical labels of the seg volume# created by mri_aparc2aseg in which the aseg cortex label is replaced# by the labels in the aparc.It also supports wm labels that will# eventually be created by mri_aparc2aseg.Otherwise,],
    "the": ["aseg labels# do not change from above.The cortical lables are the same as in #colortable_desikan_killiany.txt,],
		"except": ["that left hemisphere has# 1000 added to the index and the right has 2000 added.The label# names are also prepended with ctx - lh or ctx - rh.The white matter# labels are the same as in colortable_desikan_killiany.txt,],
    "except#": ["that left hemisphere has 3000 added to the index and the right has# 4000 added.The label names are also prepended with wm - lh or wm - rh.#Centrum semiovale is also labled with 5001(left) and 5002(right).#Even further below are the color tables],
		"for": ["aparc.a2005s and aparc.a2009s.],
...
"	":	["# Below is the color table],
    "for": ["a lobar white matter parcelation# obtained from running# mri_annotation2label--subject subject--hemi lh--lobesStrict lobes# mri_annotation2label--subject subject--hemi rh--lobesStrict lobes# mri_aparc2aseg--s subject--labelwm--hypo - as - wm--rip - unknown\#--volmask--o wmparc.lobes.mgz--ctxseg aparc + aseg.mgz\#--annot lobes--base - offset 200[--base - offset must be last arg]],
	...
	"":	["# Below is the color table],
    "for": ["the cortical labels of the seg volume# created by mri_aparc2aseg(with--a2005s flag) in which the aseg# cortex label is replaced by the labels in the aparc.a2005s.The# cortical labels are the same as in Simple_surface_labels2005.txt,],
		"#except": ["that left hemisphere has 1100 added to the index and the# right has 2100 added.The label names are also prepended with# ctx - lh or ctx - rh.The aparc.a2009s labels are further below],
	...
	"":	["# Below is the color table],
    "for": ["white - matter pathways produced by dmri_paths],
	...
	"":	["## Labels],
    "for": ["thalamus parcellation using probabilistic tractography.See: #Functional--Anatomical Validation and Individual Variation of Diffusion# Tractography - based Segmentation of the Human Thalamus;Cerebral Cortex# January 2005;15: 31--39,],
		"doi:": ["10.1093 / cercor / bhh105,],
    "Advance": ["Access# publication July 6,],
		"2004#
    ...
    "":	["# Below is the color table],
		"for": ["the cortical labels of the seg volume# created by mri_aparc2aseg(with--a2009s flag) in which the aseg# cortex label is replaced by the labels in the aparc.a2009s.The# cortical labels are the same as in Simple_surface_labels2009.txt,],
    "#except": ["that left hemisphere has 11100 added to the index and the# right has 12100 added.The label names are also prepended with# ctx_lh_,],
		"ctx_rh_,
	":	["wm_lh_ and wm_rh_(note usage of _ instead of -#to differentiate from a2005s labels).],
